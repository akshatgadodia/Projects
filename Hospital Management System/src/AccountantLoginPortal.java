...
public class AccountantLoginPortal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AccountantLoginPortal frame = new AccountantLoginPortal();
	...
	public AccountantLoginPortal() {
		...
		jLabel4.setBounds(150, 200, 200, 40);
		...
		jLabel5.setBounds(150, 250, 358, 29);

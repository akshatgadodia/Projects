...
public class DoctorLoginPortal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DoctorLoginPortal frame = new DoctorLoginPortal();
	...
	public DoctorLoginPortal() {
		...
		jLabel4.setBounds(150, 200, 239, 40);
		...
		jLabel5.setBounds(150, 250, 337, 29);
		...
		jButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "Select * from docotr  where  Username='"+a+"'";

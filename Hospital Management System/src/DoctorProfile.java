	...
	public DoctorProfile() {
		...
		jButton5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "Update doctor set DoctorID='"+x+"',Name='"+y+"',Gender='"+c+"',Address='"+d+"',DOB='"+e2+"',Qualification='"+f+"',MobileNo='"+g+"',EmailId='"+h+"',Personname='"+i+"',phoneno='"+j+"'where Username='"+a+"' and Password='"+b+"' ";
		...
		jButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql = "Insert into doctor values('"+a+"','"+b+"','"+c+"','"+d+"','"+x+"','"+f+"','"+g+"','"+h+"','"+i+"','"+k+"','"+k+"','"+l+"')";
		...
		jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/DoctorLImage.png")));

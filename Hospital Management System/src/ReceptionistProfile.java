...
public class ReceptionistProfile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReceptionistProfile frame = new ReceptionistProfile();
	...
	public ReceptionistProfile() {
		...
		jButton5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "Update Receptionist set ReceptionistID='"+x+"',Name='"+y+"',Gender='"+c+"',Address='"+d+"',DOB='"+e2+"',Qualification='"+f+"',MobileNo='"+g+"',EmailId='"+h+"',Personname='"+i+"',phoneno='"+j+"'where Username='"+a+"' and Password='"+b+"' ";
		...
		jButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql = "Insert into Receptionist values('"+a+"','"+b+"','"+c+"','"+d+"','"+x+"','"+f+"','"+g+"','"+h+"','"+i+"','"+k+"','"+k+"','"+l+"')";

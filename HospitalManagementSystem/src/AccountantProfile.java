...
public class AccountantProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(37, 193, 239));
        ...
        jButton7.setBackground(new java.awt.Color(37, 193, 239));
        ...
        jButton7.setBounds(40, 180, 10, 10);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(90, 40, 860, 70);
...
AccountLoginPortal m=new AccountLoginPortal();
   ...
   try {Class.forName("java.sql.Driver");
            ...
            String sql = "Insert into accountant values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+k+"','"+k+"','"+l+"')";
 ...
 String b=jPasswordField1.getText();
      ...
      if(rst.next())
      { 
      jTextField6.setText(rst.getString("AccountantId"));
...
this.dispose();
 ...
 String b=jPasswordField1.getText();
        try {Class.forName("java.sql.Driver");
            ...
            String sql = "Update accountant set AccountantID='"+x+"',Name='"+y+"',Gender='"+c+"',Address='"+d+"',DOB='"+e+"',Qualification='"+f+"',MobileNo='"+g+"',EmailId='"+h+"',Personname='"+i+"',phoneno='"+j+"'where Username='"+a+"' and Password='"+b+"' ";
            stmt.executeUpdate(sql);
       con.close();  
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());

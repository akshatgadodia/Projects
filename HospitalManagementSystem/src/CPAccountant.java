 ...
 * @author User  001
 */
public class CPAccountant extends javax.swing.JFrame {

    /**
     * Creates new form CPAccountant
     */
    public CPAccountant() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Change Accountant Password");
        jLabel3.setOpaque(true);
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, 30, 640, 70);
        ...
        jButton8.setBounds(40, 180, 10, 10);
  ...
  String a,b,c,d;
            ...
            String sql = "update accountant set password='"+c+"' where username='"+a+"'and password='"+b+"'";
              if(c.equals(d))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPAccountant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPAccountant().setVisible(true);
            }
        });
    }

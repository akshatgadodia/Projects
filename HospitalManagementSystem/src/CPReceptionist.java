 ...
 * @author User  001
 */
public class CPReceptionist extends javax.swing.JFrame {

    /**
     * Creates new form CPReceptionist
     */
    public CPReceptionist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Change receptionist Password");
        jLabel3.setOpaque(true);
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, 30, 660, 70);
        ...
        jButton8.setBounds(30, 160, 10, 10);
        ...
        jButton6.setBounds(10, 140, 30, 30);
 ...
 String a,b,c,d;
            ...
            String sql = "update receptionist set password='"+c+"' where username='"+a+"'and password='"+b+"'";
              if(c.equals(d))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPReceptionist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPReceptionist().setVisible(true);
            }
        });
    }
